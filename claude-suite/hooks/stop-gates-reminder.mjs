 ...
 * user that the four done-time gates (rule-audit / a11y-gate / security-pass / design-gate via
 * /gates) have not been confirmed. Advisory only — never blocks (exit 0). "Did you run the gates" is judgment,
...
process.stderr.write(
  `\n[reminder] ${codeChanges.length} changed TS file(s) not yet gated. ` +
    `Before committing, run /gates (rule-audit + a11y-gate + security-pass + design-gate) — the definition of done.\n`
);
process.exit(0);
